...
final class Actions {
	...
	public function __construct( Skautis_Login $skautisLogin, WP_Login_Logout $wpLoginLogout, ConnectAndDisconnectWpAccount $connectWpAccount, SkautisGateway $skautisGateway ) {
