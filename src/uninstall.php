...
// defined in src/admin/Settings.php
...
// defined in src/modules/Register/admin/Settings.php
...
// defined in src/modules/Shortcodes/admin/Settings.php
delete_option( 'skautis-integration_modules_shortcodes_visibilityMode' );

// defined in src/modules/Visibility/admin/Settings.php
